(function () {
  ...
  const THEMES = [
    ...
    },
    {
      ...
      accent2: '#d3ff6a',
      bgType: 'aurora',
      bgColors: ['#02120d', '#07311f', '#0c4a2d'],
      decor: {
        ribbons: ['#7dffb0', '#b8ff7a', '#35f0ff'],
        mountains: '#d8f7c0'
      },
      board: {
        fill: 'rgba(5, 24, 18, 0.97)',
        line: 'rgba(150, 255, 190, 0.86)',
        star: '#d3ff6a',
        frameTop: '#7dffb0',
        frameBottom: '#35f0ff',
        glow: 'rgba(125, 255, 176, 0.55)',
        corner: 'rgba(211, 255, 106, 0.9)'
      },
      pieces: {
        0: { core: '#0b2a1d', hi: '#1d5a3d', edge: '#7dffb0', glow: 'rgba(125,255,176,0.75)', label: '黑' },
        1: { core: '#f4fff8', hi: '#ffffff', edge: '#d3ff6a', glow: 'rgba(211,255,106,0.85)', label: '白' }
      },
      ambient: { kind: 'sparkles', count: 42, colors: ['#7dffb0', '#d3ff6a', '#ffffff', '#b8ecff'], size: [1, 2.5], speed: 16 }
    },
    {
      id: 'sunset',
      name: '暮色金砂',
      ...
      accent2: '#ffd166',
      bgType: 'lava',
      bgColors: ['#170609', '#3b0d12', '#6b1f12'],
      decor: {
        horizon: '#8a2c10',
        cracks: [
          { x: 0.16, y: 0.6, seed: 7 }, { x: 0.4, y: 0.55, seed: 19 },
          { x: 0.66, y: 0.63, seed: 31 }, { x: 0.88, y: 0.58, seed: 43 },
          { x: 0.5, y: 0.8, seed: 59 }, { x: 0.26, y: 0.82, seed: 71 }
        ]
      },
      board: {
        fill: 'rgba(36, 10, 10, 0.97)',
        line: 'rgba(255, 178, 102, 0.88)',
        star: '#ffd166',
        frameTop: '#ff9a5c',
        frameBottom: '#c84a1f',
        glow: 'rgba(255, 154, 92, 0.6)',
        corner: 'rgba(255, 209, 102, 0.9)'
      },
      pieces: {
        0: { core: '#1d0a08', hi: '#4a2014', edge: '#ffb064', glow: 'rgba(255,154,92,0.8)', label: '黑' },
        1: { core: '#fff8ea', hi: '#ffffff', edge: '#ffd166', glow: 'rgba(255,209,102,0.9)', label: '白' }
      },
      ambient: { kind: 'embers', count: 48, colors: ['#ffb066', '#ffd166', '#ff7b5c', '#fff0c2'], size: [1.4, 3.4], speed: 34 }
    },
    {
      id: 'violet',
      name: '紫晶幻境',
      ...
      accent2: '#ff86c8',
      bgType: 'neon',
      bgColors: ['#090313', '#190a38', '#35104f'],
      decor: {
        nebula: [
          { x: 0.2, y: 0.22, r: 0.52, c: '#7b4dff', a: 0.6 },
          { x: 0.82, y: 0.7, r: 0.56, c: '#ff5cc8', a: 0.5 },
          { x: 0.5, y: 0.14, r: 0.34, c: '#35f0ff', a: 0.3 },
          { x: 0.08, y: 0.88, r: 0.42, c: '#ffd166', a: 0.24 }
        ],
        shooting: true
      },
      board: {
        fill: 'rgba(16, 8, 36, 0.97)',
        line: 'rgba(196, 166, 255, 0.9)',
        star: '#ffd166',
        frameTop: '#b18cff',
        frameBottom: '#ff86c8',
        glow: 'rgba(177, 140, 255, 0.55)',
        corner: 'rgba(255, 134, 200, 0.9)'
      },
      pieces: {
        0: { core: '#150d2b', hi: '#3d2a66', edge: '#b18cff', glow: 'rgba(177,140,255,0.8)', label: '黑' },
        1: { core: '#fbf8ff', hi: '#ffffff', edge: '#ff86c8', glow: 'rgba(255,134,200,0.85)', label: '白' }
      },
      ambient: { kind: 'stars', count: 72, colors: ['#d9c8ff', '#ffb6e0', '#8ad7ff', '#ffffff'], size: [1, 2.8], speed: 10 }
    }
  ];
